...
import BusinessIntroTable from '@/components/BusinessIntroTable';

export default function AnnouncementPage() {
    const { t, language } = useLanguage();

    return (
        <div className="min-w-[1024px] max-w-6xl mx-auto p-0 bg-white min-h-screen font-sans text-[#333]">
                            ...
                            <table className="w-full text-sm border-collapse border-b border-[#ccc]">
                                ...
                                <tbody className="text-center text-[#444]">
                                    <tr>
                                        ...
                                        <td className="border border-[#e5e5e5] py-3 px-2 text-left whitespace-nowrap">{t('2026년도 신규과제 신청 공고', 'Announcement of 2026 New Projects')}</td>
                                    </tr>
                                    <tr>
                                        <td className="border border-[#e5e5e5] py-3 px-2 font-bold bg-[#fbfbfb] whitespace-nowrap">{t('2026년 4월', 'Apr 2026')}</td>
                                        <td className="border border-[#e5e5e5] py-3 px-2 text-left whitespace-nowrap">{t('2026년도 신규과제 신청 접수', 'Acceptance of 2026 New Project Applications')}</td>
                                    </tr>
                                    <tr>
                                        <td className="border border-[#e5e5e5] py-3 px-2 font-bold bg-[#fbfbfb] whitespace-nowrap">{t('2026년 5월 ~ 8월', 'May ~ Aug 2026')}</td>
                                        <td className="border border-[#e5e5e5] py-3 px-2 text-left whitespace-nowrap">{t('신규과제 선정 평가', 'Selection Evaluation for New Projects')}</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td className="border border-[#e5e5e5] py-3 px-2 text-left whitespace-nowrap">
                                            <span className="font-bold text-[#005bac]">{t('신규과제 연구 개시 (9.1)', 'Commencement of New Project Research (Sep 1)')}</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div>
                            ...
                            <div className="bg-[#f0f0f0] p-5 border border-[#ddd]">
                                <p className="text-[#333] text-sm leading-relaxed">
                                    세부사업별 <span className="font-bold text-[#005bac]">신청요강</span> 및 <span className="font-bold text-[#005bac]">양식</span>은 한국연구재단 홈페이지(<a href="https://www.nrf.re.kr" className="text-[#005bac] font-bold underline">www.nrf.re.kr</a>) 참조
                                </p>
                            </div>
                        </div>
            ...
            <footer className="text-center text-[#999] text-xs border-t border-[#eee] py-8 bg-[#f9f9f9]">
